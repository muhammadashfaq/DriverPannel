...
import com.app.driverpannel.Constants.MyAppliction;
...
public class HomeActivity extends AppCompatActivity implements
    ...
    TextView txtVulatitude,txtVuLongitude,txtVuAddress;
    ...
    String dataNotify = "Hey Welcome to OneSignal";
 Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, pref.getString("NotificationData","No Data Still"), Toast.LENGTH_SHORT).show();
        ...
        txtVuAddress = findViewById(R.id.txt_vu_address);
        ...
        victimRef.child(currentVictimID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot!=null){
                    ...
                    String address = getAddressFromLatLng(HomeActivity.this,latLng);

                    if(latitude!=null && longitude != null && status !=null && address!=null){
                        txtVulatitude.setText(latitude);
                        txtVuLongitude.setText(longitude);
                        txtVuAddress.setText(address);
                    }
                    progressDialog.dismiss();
    ...
    private void sendNotification()
    {
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                Log.i(TAG, String.valueOf(SDK_INT));
                if (SDK_INT > 8) {
                    ...
                    try {
                        ...
                        final String strJsonBody = "{"
                                ...
                                + "\"data\": {\"Foo\": \""+dataNotify+"\"},"
                                + "\"sound\": {\"Foo\": \""+R.raw.ambulance_sound+"\"},"
                                + "\"contents\": {\"en\": \"My First Notification usnig OneSignal\"}"
                                + "}";

                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(HomeActivity.this, strJsonBody, Toast.LENGTH_LONG).show();
                            }
                        });

                        Log.i(TAG,strJsonBody);
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(HomeActivity.this, jsonResponse, Toast.LENGTH_SHORT).show();
                            }
                        });
